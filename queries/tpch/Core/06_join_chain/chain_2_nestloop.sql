...
-- Nestloop join, 2-join chain (lineitem -> orders -> customer).
...
SELECT 1 FROM lineitem l JOIN orders o ON l.l_orderkey = o.o_orderkey JOIN customer c ON o.o_custkey = c.c_custkey;
