...
-- Nestloop join, 4-join chain (lineitem -> orders -> customer -> nation -> region).
...
SELECT 1 FROM lineitem l JOIN orders o ON l.l_orderkey = o.o_orderkey JOIN customer c ON o.o_custkey = c.c_custkey JOIN nation n ON c.c_nationkey = n.n_nationkey JOIN region r ON n.n_regionkey = r.r_regionkey;
